...
User.create(name: "John Smith", email: "john@smith.com", password: "password", password_confirmation: "password", role: "user")
User.create(name: "Joe Bloggs", email: "joe@bloggs.com", password: "password", password_confirmation: "password", role: "user")
